...
// pub fn get_subject(object: JsonValue) -> Subject {
//     if object.has_key("NamedNode") {
//         return Subject::NamedNode(NamedNode::new(object["NamedNode"].as_str().unwrap()).unwrap())
//     }
//     if object.has_key("BlankNode") {
//         return Subject::BlankNode(BlankNode::new(object["BlankNode"].as_str().unwrap()).unwrap())
//     }
//     panic!("Invalid subject type");
// }

// pub fn get_predicate(object: JsonValue) -> NamedNode {
//     if object.has_key("NamedNode") {
//         return NamedNode::new(object["NamedNode"].as_str().unwrap()).unwrap();
//     }
//     panic!("Invalid predicate type");
// }

// pub fn get_object(object: JsonValue) -> Term {
//     if object.has_key("NamedNode") {
//         return Term::NamedNode(NamedNode::new(object["NamedNode"].as_str().unwrap()).unwrap())
//     }
//     if object.has_key("BlankNode") {
//         return Term::BlankNode(BlankNode::new(object["BlankNode"].as_str().unwrap()).unwrap())
//     }
//     if object.has_key("Literal") {
        


//         return Term::Literal(BlankNode::new(object["Literal"].as_str().unwrap()).unwrap())
//     }
